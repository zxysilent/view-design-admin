...
module.exports = {
	...
	publicPath: process.env.NODE_ENV === "development" ? "/" : "/dist/", //http://127.0.0.1:80/dist/修改为你的URL+/dist/",
	...
	pages: {
		index: {
			...
			title: "view-design-admin", // 当使用 title 选项时,在 template 中使用：<title><%= htmlWebpackPlugin.options.title %></title>
