<template>
	<div class="lock">
		<div class="wrapper clearfix">
			<Avatar @click.native="passwordShow=true" src="https://avatars1.githubusercontent.com/u/19198355?s=400&u=aa18d8f6d07dbd4f8f4dd966f3fbb2b3a1b3ee00&v=4" style="cursor: pointer;" size="large">Lock
			</Avatar>
			<div class="input-wrapper" v-if="passwordShow">
				<input class="input" ref="input" :autofocus="true" v-model="password" placeholder="登录密码" @keyup.enter="handleUnlock" type="password">
